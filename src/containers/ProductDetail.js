...
class ProductDetail extends React.Component {
  ...
  render() {
    ...
    const item = data;
    return (
      <Container style={{ padding: "2em 0em 3em 0em" }}>
        {error && (
          <Message
            error
            header="При оформлении товара произошла ошибка"
        ...
        <Grid columns={2} divided>
          <Grid.Row>
              ...
              <Card
                ...
                header={
                  <React.Fragment>
                    <b>{item.title}</b>
                    <span>&nbsp;</span>
                    { item.label === "Акция" || item.label === "Новинка" ? (
                      <Label
                          floated="right"
                          labelPosition="right"
                        color={
            ...
            <Grid.Column>
              <Header as="h2">Попробуйте добавки и выберете упаковку</Header>
              {data.variations &&
                data.variations.map(v => {
                  return (
                          ...
                          return (
                            <Item key={iv.id}>
                              ...
                              <Item.Content verticalAlign="middle">
                                {iv.value} ({iv.weight}г) - {iv.price}р
                              </Item.Content>
                            </Item>
                          );
                        })}
